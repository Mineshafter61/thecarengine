...
data modify storage thescarengine:temp settings.placed_item.components.'minecraft:food' set value {saturation: 0.0f, nutrition: 1, can_always_eat: 1b}
data modify storage thescarengine:temp settings.placed_item.components.'minecraft:consumable' set value {consume_seconds:2.1474836E9f}
