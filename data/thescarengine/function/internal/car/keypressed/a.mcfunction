...
data modify storage thescarengine:temp data.actionbar[2].color set value "#55ff55"
...
#if playerRotateWithVehicle true
...
#.rule.player_rotate_with_vehicle datapack.temp.thecarengine.main
