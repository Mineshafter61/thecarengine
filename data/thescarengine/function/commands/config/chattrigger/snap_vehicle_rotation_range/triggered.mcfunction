...
function thescarengine:commands/config/chattrigger/snap_vehicle_rotation_range/check with storage thescarengine:temp data.config.input.content.pages[0]
