...
tellraw @s [{"text":"  Datapack Version: ","color":"#A6FDFD"},{"text":"INDEV-1.0.4","color":"#54DCDC"}]
tellraw @s [{"text":"  Resource Pack Version: ","color":"#A6FDFD"},{"translate":"datapack.thecarengine.rs_version","fallback":"\u00a7cNULL","color":"#54DCDC"},{"translate":"datapack.thecarengine.rs_active","fallback":"\n  [Download TCE Resource Pack]","color":"blue","with":[""],"hoverEvent": {"action": "show_text","contents": "Click to go to download page."},"clickEvent": {"action": "open_url","value": "https://github.com/MCTCRS/thecarengine/releases/tag/1.0.4-indev"}}]
