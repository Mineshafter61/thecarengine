#car body
summon item_display ~ ~ ~ {Tags:["datapack.thescarengine.car.parts.pivot"],Passengers:[{id:"minecraft:item_display",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.775f,0f],scale:[2f,2f,2f]},item:{id:"minecraft:firework_star",count:1,components:{"minecraft:item_name":'"Sedan"',"minecraft:custom_model_data":10001}}}]}
