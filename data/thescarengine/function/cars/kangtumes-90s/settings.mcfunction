# ================================
# Car Configuration: Kangtumes 90s
# ================================

# Car Display Name
data modify storage thescarengine:temp settings.car_display set value "kangtumes-90s"
...
# Item data ()
data modify storage thescarengine:temp settings.placed_item set value {components: {"minecraft:item_name": {"color":"#CCFFFF","text":"Kangtumes 90s"}, "minecraft:lore": [{"extra":[{"bold":false,"color":"gray","italic":false,"obfuscated":false,"strikethrough":false,"text":"Right-Click to place vehicle","underlined":false}],"text":""}, "", {"extra":[{"bold":false,"color":"gray","italic":false,"obfuscated":false,"strikethrough":false,"text":"Vehicle Info:","underlined":false}],"text":""}, {"extra":[{"bold":false,"color":"gray","italic":false,"obfuscated":false,"strikethrough":false,"text":" Brand: Kangtumes","underlined":false}],"text":""}, {"extra":[{"bold":false,"color":"gray","italic":false,"obfuscated":false,"strikethrough":false,"text":" Type: Single-Seater","underlined":false}],"text":""}, {"extra":[{"bold":false,"color":"gray","italic":false,"obfuscated":false,"strikethrough":false,"text":" Max Speed: 100km/h","underlined":false}],"text":""}], "minecraft:max_stack_size": 1,"hide_additional_tooltip":{}}, count: 1, id: "minecraft:light_gray_dye"}
