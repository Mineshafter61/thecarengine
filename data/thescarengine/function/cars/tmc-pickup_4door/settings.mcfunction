# ================================
# Car Configuration: TMC Pickup (4 door)
# ================================

# Car Display Name
data modify storage thescarengine:temp settings.car_display set value "tmc-pickup_4door"
...
data modify storage thescarengine:temp settings.max_vel set value 2.152
...
# Item data ()
data modify storage thescarengine:temp settings.placed_item set value {components: {"minecraft:custom_model_data":{floats:[10000]}, "minecraft:item_name": {"color":"#CCFFFF","text":"TMC Pickup"}, "minecraft:lore": [{"extra":[{"bold":false,"color":"gray","italic":false,"obfuscated":false,"strikethrough":false,"text":"Right-Click to place vehicle","underlined":false}],"text":""}, "", {"extra":[{"bold":false,"color":"gray","italic":false,"obfuscated":false,"strikethrough":false,"text":"Vehicle Info:","underlined":false}],"text":""}, {"extra":[{"bold":false,"color":"gray","italic":false,"obfuscated":false,"strikethrough":false,"text":" Brand: TMC","underlined":false}],"text":""}, {"extra":[{"bold":false,"color":"gray","italic":false,"obfuscated":false,"strikethrough":false,"text":" Type: Pickup","underlined":false}],"text":""}, {"extra":[{"bold":false,"color":"gray","italic":false,"obfuscated":false,"strikethrough":false,"text":" Max Speed: 155km/h","underlined":false}],"text":""}], "minecraft:max_stack_size": 1,"hide_additional_tooltip":{}}, count: 1, id: "minecraft:firework_star"}
