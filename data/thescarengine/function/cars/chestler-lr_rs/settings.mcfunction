# ================================
# Car Configuration: Chestler LR (RS)
# ================================

# Car Display Name
data modify storage thescarengine:temp settings.car_display set value "chestler-lr_rs"
...
data modify storage thescarengine:temp settings.turn set value {str: 0, div: 1, mul: 6, max: 5}
...
# Main Body
data modify storage thescarengine:temp settings.colored[{part:"datapack.thescarengine.car.parts.pivot"}].color set value 6323737
# Wheels
