# ================================
# Car Configuration: TMC-Pickup
# ================================

# Car Display Name
data modify storage thescarengine:temp settings.car_display set value "tmc-pickup"
